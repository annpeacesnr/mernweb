            ...
            <div className="container my-5 py-5">
                <div className="row">
                    <div className="col-md-6">
                        <img src="/assets/house.jpg" alt="About" className="w-75 mt-5" />
                    </div>
                    <div className="col-md-6">
                        <h3 className="fs-5 mb-0">About Us</h3>
                        <h1 className="display-6 mb-2"><b>Who We Are</b></h1>
                        <hr className="w-50"/>
                        ...
                        <button className="btn btn-outline-primary rounded-pill px-4 py-2 ms-2">Create Booking</button>          
                    </div>
                </div>
            </div>
        </section>
